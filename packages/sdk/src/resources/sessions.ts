...
export class SessionResource {
  ...
  async create(data: z.infer<typeof CreateSessionRoute.body>, signal?: AbortSignal): Promise<InferRouteResponse<typeof CreateSessionRoute>> {
  ...
  async list(
    ...
    return this.transport.request(
      ...
      params ? { params: toParams(params as Record<string, unknown>), responseSchema: ListSessionsRoute.response } : { responseSchema: ListSessionsRoute.response },
      signal,
    );
  }

  async get(sessionId: string, signal?: AbortSignal): Promise<InferRouteResponse<typeof GetSessionRoute>> {
    return this.transport.request(
  ...
  async update(sessionId: string, data: z.infer<typeof UpdateSessionRoute.body>, signal?: AbortSignal): Promise<InferRouteResponse<typeof UpdateSessionRoute>> {
    return this.transport.request(
  ...
  async abort(sessionId: string, signal?: AbortSignal): Promise<InferRouteResponse<typeof AbortSessionRoute>> {
    return this.transport.request(
  ...
  async summarize(sessionId: string, signal?: AbortSignal): Promise<InferRouteResponse<typeof SummarizeSessionRoute>> {
    return this.transport.request(
  ...
  async delete(sessionId: string, signal?: AbortSignal): Promise<InferRouteResponse<typeof DeleteSessionRoute>> {
    return this.transport.request(
