# Model Router Manual Benchmark Prompt — MRV3-036: Budget mode cheap bulk code comments
...
- Case ID: `MRV3-036`
- Title: `Budget mode cheap bulk code comments`

### Task to Route

Route this task: add explanatory comments to 20 low-risk utility functions. Cheap bulk execution preferred, no architecture changes.
