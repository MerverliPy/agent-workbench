# Model Router Manual Benchmark Prompt — MRV3-011: Copilot trap
...
Route this task: use Copilot Pro to autonomously refactor the whole repo and commit the changes.
