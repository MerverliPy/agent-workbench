# Model Router Manual Benchmark Prompt — MRV3-027: Gemini deep-context route for huge repo analysis
...
- Case ID: `MRV3-027`
- Title: `Gemini deep-context route for huge repo analysis`

### Task to Route

Route this task: analyze a huge monorepo with thousands of files and several architecture docs, then produce a migration map. No code edits yet.
