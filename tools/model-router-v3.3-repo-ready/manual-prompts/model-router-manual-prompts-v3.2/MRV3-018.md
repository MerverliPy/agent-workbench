# Model Router Manual Benchmark Prompt — MRV3-018: Premium quality mode
...
- Case ID: `MRV3-018`
- Title: `Premium quality mode`

### Task to Route

Route this task: maximum quality only; design an agent orchestration system and review the implementation plan before coding.
