# Model Router Manual Benchmark Prompt — MRV3-001: Simple README edit
...
- Case ID: `MRV3-001`
- Title: `Simple README edit`

### Task to Route

Route this task: update the README typo and add one checklist item. No code changes.
