# Model Router Manual Benchmark Prompt — MRV3-003: Large repo refactor
...
- Case ID: `MRV3-003`
- Title: `Large repo refactor`

### Task to Route

Route this task: refactor the repo-wide config system across 12 files and preserve backward compatibility.
