# Model Router Manual Benchmark Prompt — MRV3-030: Qwen local private medium task
...
- Case ID: `MRV3-030`
- Title: `Qwen local private medium task`

### Task to Route

Route this task: privately analyze a local proprietary module and draft a small non-production patch offline. I do not want cloud upload.
