# Model Router Manual Benchmark Prompt — MRV3-006: Local private file explanation
...
- Case ID: `MRV3-006`
- Title: `Local private file explanation`

### Task to Route

Route this task: explain a private local file offline and do not send code to cloud models.
