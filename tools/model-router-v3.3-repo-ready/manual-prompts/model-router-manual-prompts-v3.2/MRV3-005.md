# Model Router Manual Benchmark Prompt — MRV3-005: Current model comparison
...
- Case ID: `MRV3-005`
- Title: `Current model comparison`

### Task to Route

Route this task: compare the latest OpenAI, Claude, Gemini, Grok, Mistral, DeepSeek, and Qwen model options for opencode today.
