# Model Router Manual Benchmark Prompt — MRV3-032: OpenRouter as access layer only
...
- Case ID: `MRV3-032`
- Title: `OpenRouter as access layer only`

### Task to Route

Route this task: use OpenRouter to pick a cheap model for a low-risk docs cleanup and changelog rewrite.
