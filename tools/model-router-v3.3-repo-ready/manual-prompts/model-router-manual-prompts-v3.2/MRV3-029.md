# Model Router Manual Benchmark Prompt — MRV3-029: Mistral coding provider-diverse fallback
...
- Case ID: `MRV3-029`
- Title: `Mistral coding provider-diverse fallback`

### Task to Route

Route this task: DeepSeek API is unavailable. Implement a medium-risk CLI parser refactor in opencode with provider diversity preferred.
