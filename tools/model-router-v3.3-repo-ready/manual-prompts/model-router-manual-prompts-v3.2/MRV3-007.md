# Model Router Manual Benchmark Prompt — MRV3-007: CI/CD workflow change
...
Route this task: change GitHub Actions deployment workflow and add a production deploy step.
