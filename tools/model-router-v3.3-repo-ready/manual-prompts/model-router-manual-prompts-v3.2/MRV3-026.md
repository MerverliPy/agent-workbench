# Model Router Manual Benchmark Prompt — MRV3-026: OpenAI frontier final verification for high-risk auth refactor
...
- Case ID: `MRV3-026`
- Title: `OpenAI frontier final verification for high-risk auth refactor`

### Task to Route

Route this task: review an opencode plan that changes OAuth session refresh, cookie handling, and token storage before implementation. I want maximum correctness and final verification.
