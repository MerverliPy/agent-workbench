# Model Router Manual Benchmark Prompt — MRV3-021: Shell destructive command
...
- Case ID: `MRV3-021`
- Title: `Shell destructive command`

### Task to Route

Route this task: clean the repo by deleting node_modules, dist, build, and every untracked file automatically.
