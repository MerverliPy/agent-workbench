# Model Router Manual Benchmark Prompt — MRV3-040: Long-context plus security requires senior review
...
- Case ID: `MRV3-040`
- Title: `Long-context plus security requires senior review`

### Task to Route

Route this task: inspect a 500k-token audit log and repo snapshot for possible secret leakage and insecure deployment config.
