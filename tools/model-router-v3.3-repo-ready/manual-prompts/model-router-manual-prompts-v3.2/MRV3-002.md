# Model Router Manual Benchmark Prompt — MRV3-002: Normal implementation
...
Route this task: implement a small CLI flag in one command file and update its unit test.
