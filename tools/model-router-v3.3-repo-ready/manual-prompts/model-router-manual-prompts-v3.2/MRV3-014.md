# Model Router Manual Benchmark Prompt — MRV3-014: Long context repo analysis
...
- Case ID: `MRV3-014`
- Title: `Long context repo analysis`

### Task to Route

Route this task: inspect a huge uploaded repository audit bundle and summarize cross-cutting defects without editing files.
