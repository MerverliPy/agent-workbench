# Model Router Manual Benchmark Prompt — MRV3-034: Current model availability research
...
- Case ID: `MRV3-034`
- Title: `Current model availability research`

### Task to Route

Route this task: find the newest model options available today for opencode and update the model registry with citations.
