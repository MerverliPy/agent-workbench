# Model Router Manual Benchmark Prompt — MRV3-037: Maximum correctness database migration
...
- Case ID: `MRV3-037`
- Title: `Maximum correctness database migration`

### Task to Route

Route this task: design and implement a production database migration with rollback plan, data validation, and CI deployment changes. Maximum correctness.
