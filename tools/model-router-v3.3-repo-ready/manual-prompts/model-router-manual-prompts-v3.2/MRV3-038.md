# Model Router Manual Benchmark Prompt — MRV3-038: Provider preference overridden by current research
...
- Case ID: `MRV3-038`
- Title: `Provider preference overridden by current research`

### Task to Route

Route this task: use DeepSeek only to compare the latest OpenAI, Claude, Gemini, DeepSeek, and Qwen coding models available today.
