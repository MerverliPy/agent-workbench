  ...
  app.patch(
    ...
    createJsonRouteHandler(
      ...
      (_ctx, { validated }) => {
        ...
        if (body.taskCategories !== undefined)
          patch.taskCategories = body.taskCategories;
        if (body.contextLimit !== undefined)
          patch.contextLimit = body.contextLimit;
        if (body.costPer1KInput !== undefined)
          patch.costPer1KInput = body.costPer1KInput;
        if (body.costPer1KOutput !== undefined)
          patch.costPer1KOutput = body.costPer1KOutput;
        if (body.supportsStreaming !== undefined)
          patch.supportsStreaming = body.supportsStreaming;
