# Model Router Manual Benchmark Prompt — MRV3-023: API docs current version
...
- Case ID: `MRV3-023`
- Title: `API docs current version`

### Task to Route

Route this task: update code for the newest OpenAI Responses API based on current official docs.
