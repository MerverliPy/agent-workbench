# Model Router Manual Benchmark Prompt — MRV3-004: Auth/session high risk
...
- Case ID: `MRV3-004`
- Title: `Auth/session high risk`

### Task to Route

Route this task: redesign login sessions, cookie security, and password reset flow.
