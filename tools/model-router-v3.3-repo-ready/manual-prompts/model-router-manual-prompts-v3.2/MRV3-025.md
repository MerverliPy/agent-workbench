# Model Router Manual Benchmark Prompt — MRV3-025: Output format compliance
...
Route this task: evaluate my model-router prompt and tell me which model should grade it.
