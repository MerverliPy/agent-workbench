...
* packages/compliance: immutable audit, PII scan, FIPS helpers, air-gapped mode.
...
Phases 0–30 are complete.

See docs/27_PROJECT_ROADMAP.md for the full project history.
