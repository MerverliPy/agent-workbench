# Model Router Manual Benchmark Prompt — MRV3-010: Failed Flash escalation
...
- Case ID: `MRV3-010`
- Title: `Failed Flash escalation`

### Task to Route

Route this task: DeepSeek Flash already looped twice trying to fix a failing parser bug across multiple files.
