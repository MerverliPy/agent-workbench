# Model Router Manual Benchmark Prompt — MRV3-035: xAI Grok coding candidate fallback
...
- Case ID: `MRV3-035`
- Title: `xAI Grok coding candidate fallback`

### Task to Route

Route this task: DeepSeek and Claude are unavailable. I have xAI/Grok coding access. Implement a medium-risk agent workflow helper and require final verification.
