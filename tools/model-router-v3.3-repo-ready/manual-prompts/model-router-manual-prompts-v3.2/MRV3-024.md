# Model Router Manual Benchmark Prompt — MRV3-024: Inline autocomplete only
...
- Case ID: `MRV3-024`
- Title: `Inline autocomplete only`

### Task to Route

Route this task: while editing one function in VS Code, I want inline suggestions for variable names.
