# Model Router Manual Benchmark Prompt — MRV3-016: Handoff compression
...
Route this task: compress this session and create a downloadable handoff file; do not continue project work.
