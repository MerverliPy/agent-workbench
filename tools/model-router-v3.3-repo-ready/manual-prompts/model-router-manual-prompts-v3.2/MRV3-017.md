# Model Router Manual Benchmark Prompt — MRV3-017: Cheap bulk docs
...
- Case ID: `MRV3-017`
- Title: `Cheap bulk docs`

### Task to Route

Route this task: generate boilerplate issue templates and docs pages cheaply across a repo.
