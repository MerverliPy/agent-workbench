# Model Router Manual Benchmark Prompt — MRV3-039: Provider registry missing model fallback
...
- Case ID: `MRV3-039`
- Title: `Provider registry missing model fallback`

### Task to Route

Route this task: use a model called UltraCoder-Z9 for a medium-risk refactor. It is not in the registry.
