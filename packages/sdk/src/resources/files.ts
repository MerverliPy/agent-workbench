...
export class FileResource {
  ...
  async list(
    ...
    signal?: AbortSignal,
  ): Promise<InferRouteResponse<typeof ListFilesRoute>> {
    return this.transport.request(
      ...
      params
        ? {
            ...
            responseSchema: ListFilesRoute.response,
          }
        : { responseSchema: ListFilesRoute.response },
      signal,
    );
  ...
  async read(
    ...
    signal?: AbortSignal,
  ): Promise<InferRouteResponse<typeof ReadFileRoute>> {
    return this.transport.request(
      ReadFileRoute.method,
      ReadFileRoute.path,
      {
        params: toParams(params as Record<string, unknown>),
        responseSchema: ReadFileRoute.response,
      },
      signal,
    );
  }
  ...
  async diff(
    params: { path: string; targetPath?: string },
    signal?: AbortSignal,
  ): Promise<InferRouteResponse<typeof GetFileDiffRoute>> {
    return this.transport.request(
      GetFileDiffRoute.method,
      GetFileDiffRoute.path,
      {
        params: toParams(params as Record<string, unknown>),
        responseSchema: GetFileDiffRoute.response,
      },
      signal,
    );
  }
  ...
  async tree(
    params?: { path?: string },
    signal?: AbortSignal,
  ): Promise<InferRouteResponse<typeof GetFileTreeRoute>> {
    return this.transport.request(
      ...
      params
        ? {
            params: toParams(params as Record<string, unknown>),
            responseSchema: GetFileTreeRoute.response,
          }
        : { responseSchema: GetFileTreeRoute.response },
      signal,
    );
