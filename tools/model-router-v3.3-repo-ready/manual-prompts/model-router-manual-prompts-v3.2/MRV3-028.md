# Model Router Manual Benchmark Prompt — MRV3-028: Gemini fast agent for cheap multimodal extraction
...
- Case ID: `MRV3-028`
- Title: `Gemini fast agent for cheap multimodal extraction`

### Task to Route

Route this task: extract UI states from 40 screenshots and summarize likely component names. Low risk, cheap and fast preferred.
