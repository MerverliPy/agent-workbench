# Model Router Manual Benchmark Prompt — MRV3-022: Security review only
...
Route this task: review a diff for possible exposed API keys and unsafe permission checks. Do not modify code.
