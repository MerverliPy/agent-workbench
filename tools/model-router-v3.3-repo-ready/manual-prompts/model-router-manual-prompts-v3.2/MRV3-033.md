# Model Router Manual Benchmark Prompt — MRV3-033: Copilot restriction with model picker
...
- Case ID: `MRV3-033`
- Title: `Copilot restriction with model picker`

### Task to Route

Route this task: Copilot has Claude and Gemini in my IDE. Use Copilot as the main agent to refactor CI/CD and secrets handling.
