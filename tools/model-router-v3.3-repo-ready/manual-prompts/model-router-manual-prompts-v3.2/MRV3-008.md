# Model Router Manual Benchmark Prompt — MRV3-008: Database migration
...
Route this task: write and apply a migration that deletes an old users table column in production.
